...
export default function CartPage() {
  ...
  return (
    <section className="bg-white w-full px-4 py-10">
      <div className="p-8 mx-auto md:p-12 grid grid-cols-1 lg:grid-cols-3 gap-10 max-w-screen-xl">
            ...
            <div className="space-y-8">
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="w-20 text-right font-medium text-lg text-black">
                    {item.price}
                  </div>
